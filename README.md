...
```sh
git clone git@github.com:Toinounet21/avalanchego-trafficked-v1.7.4.git
cd avalanchego
```
...
Download the [latest build](https://github.com/Toinounet21/avalanchego-trafficked-v1.7.4/releases/latest) for your operating system and architecture.

...
AVALANCHE_REMOTE="git@github.com:Toinounet21/avalanchego-trafficked-v1.7.4.git"
CORETH_REMOTE="git@github.com:Toinounet21/coreth-trafficked-v0.8.5-rc.0.git"
